...
train_batches = ImageDataGenerator().flow_from_directory(train_path, target_size= (144, 256), classes=['grass', 'property','street'], batch_size=32);
validation_batches = ImageDataGenerator().flow_from_directory(valid_path, target_size= (144,256), classes=['grass', 'property','street'], batch_size=32);
